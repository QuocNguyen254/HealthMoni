        ...
        <div class="right">
            <div class="top">
                ...
                <div class="theme-toggler">
                    <span class="material-icons" onclick={light_mode()}>light_mode</span>
                    <span class="material-icons" onclick={dark_mode()}>dark_mode</span>
                    <script>
                        var theme = document.getElementsByClassName("theme-toggler");
                        theme.classList.add()
                    </script>
                </div>
                <div class="profile">
